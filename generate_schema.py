...
if not os.path.exists("reports/db/images"): os.makedirs("reports/db/images")


# Write the table string to a file
with open("reports/db/schema_dump.txt", "w") as targetFile:
...
render_er(metadata, 'reports/db/images/schema_diagram.svg') 
...
render_er(filtered_metadata, 'reports/db/images/schema_diagram_without_factionrecord.svg')
...
render_er(large_table_metadata, 'reports/db/images/schema_diagram_for_factionrecords.svg')
